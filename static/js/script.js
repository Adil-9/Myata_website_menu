...
function cartData(id, name, description, price, btn) {
  if (btn.classList.contains("fa-square-plus")) {
    ...
    var t = template
      .replace("SampleName", name)
      .replace("SamplePrice", price + " tg")
      .replaceAll("SampleId", id)
      .replaceAll("CountId", cid);
    target.insertAdjacentHTML(
      "beforeend",
      t.replace("SampleDescription", description)
    );
    cid += "a";
